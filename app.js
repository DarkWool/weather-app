...
function formatWeatherData(data, location) {
    ...
    sunrise = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(sunrise, "h:mm aaaa");
    sunset = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(sunset, "h:mm aaaa");

    const hourlyForecast = data.hourly.slice(1, 25);
    const newArr = [];
    hourlyForecast.forEach((el, index) => {
        let hour = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(el.dt * 1000), "h:mm aaaa");
    ...
    return {
        "current": {
            "dt": (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(data.current.dt * 1000), "MMMM do, h:mm aaaa"),
